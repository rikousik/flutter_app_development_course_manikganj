...
class PerfumeDetails extends HookWidget {
  ...
  // String currentPicture = 'asset/perfume.png';
  @override
  Widget build(BuildContext context) {
    final currentPicture = useState(similarPs[0]);
                ...
                SizedBox(
                  ...
                  child: ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        return InkWell(
                          onTap: () {
                            currentPicture.value = similarPs[index];
                          },
                          child: Container(
                            height: 100,
                            width: 100,
